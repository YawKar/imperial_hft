...
inline __attribute__((always_inline)) double calc_mean(const std::vector<double>& v, double sum) {
    // implementation...
...
inline __attribute__((always_inline)) double calc_stddev(const std::vector<double>& v, double mean, double sq_sum) {
    // implementation...
